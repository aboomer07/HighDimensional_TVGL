...
\begin{frame}{Application of Network Theory \cite{page1999pagerank}}
	\begin{itemize}
		...
		% \item In \cite{page1999pagerank}, the authors describe PageRank with the metaphor of a random surfer who randomly
        % selects links within webpages to transition to the next webpage.
